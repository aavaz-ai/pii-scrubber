...
func Benchmark_100Sentences(b *testing.B) {
	var data = []string{
		...
		"Excellent",
		"Super app",
		"The best online meeting app. Takes less data, that is the best product.",
		"Too good app for students and worker i like it",
		"This app not working properly it has lots of net work issues",
		"After updating dis app is not responding properly always it is showning error occured",
		"I cannot on mute 🔕🔕🔕🔕",
		"Very bad app",
		"Very bad app uselesss not working properly I prefer gogle meet",
		"Op",
		"Very very poor network of zoom",
		"Wow sub hai",
		"Very bad app connecting to meetings is too slow and anytime my zoom exit the meeting",
		"Worst aap",
		"Mp",
		"Good",
		"Super🥳",
		...
		"Ok",
		"Nice",
		"The service seems to be improving every month. Thanks for sharing this technology!",
		"Nice app very useful and nice for classes and screen sharing whiteboard etc.. I love to be host in this 😍",
		"Easy using app but some time it shows network error I want to tell to zoom employer to update the app in the modern way the app is not like the modern apps such as Google Instagram.",
		"This is not sing in and very baker 🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬🤬 plesh sing in",
		"Good apps",
		"Waste",
		"My study is very well. This app is good for school classes.",
		"It is cool and good",
		"It is very bad app I preferred Google meet is best than zoom. Zoom connecting problem issue video quality is not best and many things zoom application are bad",
		"👋",
		"Very bad, I can't see clearly of other videos and clear voic",
		"Nice",
		"it always downlode emoji pack plz do something for it",
		"Very bad",
		"Very bad",
		"I have good internet but it not working on this rubish app",
		"whenever i use link that my teacher sent me it shows connecting and whenever i use a desktop with that id and password it works properly, zoom plz fix mobile app it is very glitchy",
		"Good",
		"It's is taking too much time to connect in meatings i think it is a bug or server can't take load I have checked my internet speed but it doesn't matter in this case please fix this issue and it will be ofcourse 5 Star rating",
		"Jeremia",
		"Good",
		"Best for meeting",
		"Class is borring",
		"I'm using zoom for online classes since the corona pandemic has started. So, It's my partner that helps me connect myself remotely with my teacher. But when I try to take screenshots the video preview,🎥 option comes like obstakles in my screenshots. It's hilarious. This problem should be solved.",
		"Usless app 😢😢class start ho gaya",
		"lali app0",
		"Good",
		"It is automatically exiting and it says you cant login",
		"It is taking mor data",
		"There is a network problem but nice app",
		"My experience is great. I use this often. I would like to see a few options for putting I'm a background. I don't always want people to see where I'm at.",
		"Super 😘",
		"All time connection issue",
		"Excellent",
		"It's sucks. Everytime I join my meeting it shows connecting or preparing meeting and then it shows that network issues occur but my network is all right. Thus, I'm unable to join my meeting.Try to solve the issue asap.😑😠",
		"Mast",
		"Gg",
		"Full network errors",
		"I ever seen this worst app In this meeting host spotlighting the participants some time server error occurring.",
		"Jo bhi ye review pad raha hoo too subscriber Karo mere channel ko my channel name is yuvraj Tech gamer ok Jaldi se karo fata fat",
		"He tumchi app lay hang hoti an mazya phone mdhe lvkr install pn hoina zaliya jra chek kra tumchi app ky tri fake krt jau nka",
		"Vry bad",
		"💩",
		"Worst app",
		"Only one star left becouse we want vartul background in mobile, This is ver use for my class",
		"Osm app",
		"Not working properly",
		"Network problem in this app is common",
		"Sugla zoom",
		"This application is not downloading zoom",
		"If I join a meeting, it will automatically go out",
		"Bad I can't login",
		"This app is very useful for students",
		"Nice",
		"Faltu app",
		"Pls try and fix your update problems",
		"It so lay",
		"Faltu",
		"Great wonderful",
		"Worst ever app . My classes are taken on ZOOM app but whenever I try to join the meet It gets disconnected automatically . I confessed my teachers to take class on Google meet but they refused. Now What can I do? Worst ever app.",
		"Whenever i click on the link send by the host it only shows launch meeting but not entering into the meeting",
		"I love it 💓",
		"If show network error",
		"This app is nice but there is so much sign in and sign up issue please do something.",
		"Khushali parjapati32",
		"It was good before but now .........",
		"am dialy attending class by this😭😂",
		"Waste",
		"👍",
		"Nice app",
		"Always Connecting .. problem or server down",
		"Privacy at it's worst ... No reply to the problems reported. Will be the best application once this problem is resolved.",
		"This app will show always network error",
		"Oppppp",
		"Worst app",
		"Nice and easy to use",
		"Worst app not working properly and always showing error you can't join meeting, always network issue please resolve it.",
		"At first it was running smoothly but now it has many glitches as it is taking so much time to connect with a meeting....and even after connecting there is a lot of network issues in this app!",
		"Too good",
		"Very bad app",
		"I hv been using zoom for my online classes for 2 years now. It worked well in the starting but after the latest update I am unable to connect to my classes. Evertime it shows some kind of error. It's a humble request to kindly fix it🙏🏻🙏🏻",
		"Alwys disconnecting which is too embarassing to face with the clases going on",
		"বাজে গুগল মীট ভালো",
		"Best from others app",
		"Nice",
		"This is so nonsense app whenever we start meeting somthing error occurred and dissconnect into the meeting 😡😡 please recover this app",
		"Very nice",
		"Meeting is not connecting here is a problem when it is connecting it say please wait and remove me from meeting...",
		"No words so very bad",
		"Worst",
		"I give star because this has connecting problem plz fix this problem soon because I want to attend online classes plz fix this problem soon only connecting only showing on the screen",
		"Strucking",
		"There is login problem please fix.....",
		"Good",
		"This app is having many audio essues and i am again and again stuck at connecting screen worst app",
		"It is a good app",
		"Good",
		"Just good",
		"Please delete this app This app is so bad Delete it fast",
		"Virtual background option is not showing in my android phone",
		"Very Good app",
		"It is very good app but video is not clear",
		"Super",
		"Connecting bug problem",
		"I like so much this app easy for hear my online classes this is best app for child's",
		"It's very nice But its was stuck",
		"This app is bad. Make it like ms teams",
		"App is not eligible for 1 star also .. but I don't have any other option, I don't know why but my tuition teacher uses it this is the worst app I have ever had... Never lets me in. Whenever I join the meeting kicks me out then rejoins me again this lasts for the whole entire meeting",
		"Picture change",
		"Ok not that bad very good",
		"Fullest problem app",
		"Ok",
		"Mast app",
		"This is good app for meeting",
		"Zoom please apply the feature to apply another background otherwise this is the best app for meetings but one problem you have to apply a different backgrounds for all then this app deserves 5 star otherwise 4",
		"Very worst app never use this app unble to attend the meeting after the sign in too I wasted my CLS due to this",
		"Very good",
		"Showing 2 screens of same person , developer should focus on this glitch",
		"Always nice experience",
		"Help",
		"Very nice for class",
		"My battery is draining a lot when am using this app.. 13% of Battery is drained for just 40 mins of meeting.. even I have enabled the Battery intelligent control in My OnePlus mobile.. pls fix this issue !!",
		"Nice",
		"Best aap",
		"Op",
		"It was a great experience on zoom for the meeting conduction with successful programming.",
		"This app is super I liked it is so easy to take class",
		"Nepali",
		"It automatically on my 🎤 when I am doing online class worst app😤",
		"Audio is not working",
		"Super",
		"Excellent",
		"Good",
		"Nice app",
		"मीटिंग होस्ट करने का बेहतरीन विकल्प",
		"This is the worst app it does not even deserve 1 star I am only using it because my teachers use this app for online class",
		"Very good",
		"Today it is not working what we can do tell",
		"Good app",
		"Good for meeting",
		"I am using it from the covid situation. I think this is a good app.👌",
		"Good",
		"Sosite",
		"Op",
		"This app is very bad giving 1 Star because other apps are working properly with network but this app not after updating also 😡😡😡😡",
		"Good",
		"App is too great",
		"Very Very Good",
		"It is good app .but it is cuting of after 45mins",
		"Sometimes it will be black screen and be not connencting and say wrong password",
		"Best app",
		"Soo much usefull",
		"It's a very good app",
		"Good working butsometimes much more hang..",
		"Very bad",
		"Good",
		"Very bad because online class is take on this app",
		"Very bad app",
		"Good",
		"Go for it",
		"Very poor audio and video connection",
		"Best app for classes and very very useful",
		"Waste app there are many technical issue",
		"Good",
		"Nice app",
		"I m not able to install this App.please help",
		"I can not connect to meeting even if my network connection is good",
		"Amazing no adds",
		"I'm regretting why I updated this. It always show connecting and then automatically comes out of meeting. Today I was not able to join the meeting. After updation it has just become trash.",
		"Nice",
		"Waste app App is not responding",
		"I love the app!! It's just that sometimes it would freeze... not sure if it was the app or my connection.",
		"Not bad",
		"Perfect!!!",
		"Now I can easily take my classes",
		"Ok",
		"Classy Ne chalu ho rahi hai",
		"Very good",
		"Super",
		"Plese help for cancel school meeting",
		"So nice and useful app",
	}
